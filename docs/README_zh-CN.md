...
<p align="center">
  <img src="https://raw.githubusercontent.com/jinzcdev/vscode-pintia/main/docs/gifs/codelens.gif" alt="自定义测试样本" />
</p>
...
| 设置名称                  | 描述                                                         | 默认值           |
| ------------------------- | ------------------------------------------------------------ | ---------------- |
| `pintia.showLocked`       | 指定是否显示锁定的问题。一些问题集可以在输入阅读器的代码时提交 | `true`           |
...
如果你的问题仍然无法解决，可随时[创建一个新的Issue](https://github.com/jinzcdev/vscode-pintia/issues/new/choose)。

## 更新日志

请参考[变更日志](https://github.com/jinzcdev/vscode-pintia/blob/main/CHANGELOG.md)
